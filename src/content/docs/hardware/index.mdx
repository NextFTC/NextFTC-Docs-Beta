...
```java
NextServo servo = new NextServo(RobotController.controlHub(), 0); // By Lynx Module and port, recommended
...
<CardGrid>
  <LinkCard
    title="Actuators"
    href="/hardware/actuators/motors/"
    description="Motors, servos, continuous-rotation servos, and feedback servos."
  />
  <LinkCard
    title="Sensors"
    href="/hardware/sensors/color-sensor/"
