...
| -------------------------------------------------------------------------------------------------- | -------- | ------- | --------------------------------------------------------------------------------- |
| `anglePerCount`                                                                                    | `Angle`  | 1.0 rad | The angle that a motor's shaft rotates by for every 'tick' or 'count'.            |
| Used for calculations that directly convert 'ticks' to the number of rotations the motor has spun. |
