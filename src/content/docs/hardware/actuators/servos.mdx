...
`PwmControl.PwmRange` is the servo's PWM range configuration. Get or set directly, or use [`setPwmRange`](#setpwmrangelower-upper) for a more convenient two-argument setter.
